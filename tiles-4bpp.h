...
hagl_color_t tile_8x8x4_0_bitmap[] = {
  ...
  /* 1 */ BG, BG, G1, G1, BG, BG, BG, BG,
  /* 2 */ BG, G1, G2, G2, BG, BG, BG, BG,
  /* 3 */ BG, BG, G2, G2, G1, BG, B2, BG,
  /* 4 */ BG, BG, G1, G1, BG, BG, BG, BG,
  /* 5 */ BG, BG, BG, BG, BG, B0, BG, BG,
  /* 6 */ BG, BG, B1, BG, BG, BG, BG, BG,
...
hagl_color_t tile_8x8x4_3_bitmap[] = {
  ...
  /* 2 */ BG, BG, BG, BG, BG, BG, BG, BG,
  /* 3 */ BG, BG, BG, BG, G1, BG, BG, BG,
  /* 4 */ BG, BG, BG, G1, G0, G1, BG, BG,
  /* 5 */ BG, BG, BG, BG, G1, BG, BG, BG,
  /* 6 */ BG, BG, BG, BG, BG, BG, G2, BG,
  /* 7 */ BG, BG, BG, BG, BG, BG, BG, BG,
};
